...
import static com.github.stashuk.battleship.model.CellState.*;
import static com.github.stashuk.battleship.model.FireResult.*;
    ...
    private Set<Cell> getAdjacentCellsForShipCell(Cell cell) {
        ...
        for (int x = cell.getX() - 1; x <= cell.getX() + 1; x++) {
            for (int y = cell.getY() - 1; y <= cell.getY() + 1; y++) {
                if (Verifications.coordinatesCorrect(x, y) && getCellAt(x, y).getState() == EMPTY) {
